import { IsBoolean, IsDateString, IsInt, IsNotEmpty, IsOptional, IsString, Length, Matches, MaxLength, Min } from 'class-validator';
...
export class CreateUserDto {
  ...
  // plain password فقط برای ساخت؛ در سرویس به password_hash تبدیل می‌شود
